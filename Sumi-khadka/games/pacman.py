...
for i in range(1, num_images+1):
    try:
        img_path = os.path.join('assets', 'player_images', f'{i}.png')
        image = pygame.image.load(img_path)
        image = pygame.transform.scale(image, (45, 45))  # Resize to 45x45
        player_images.append(image)
        print(f"Loaded: {img_path}")  # Debugging
...
if player_images:
    print(f"Successfully loaded {len(player_images)} images.")
else:
